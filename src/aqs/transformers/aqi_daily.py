...
def transform_aqi_daily(raw_daily_files: List[Path]) -> pd.DataFrame:
    ...
    if not available_fields:
        raise ValueError("None of the requested fields are present in the raw daily data")
    ...
    print(f"✅ Processed AQI daily data: {original_count} → {deduped_count} records after deduplication and AQI filtering")
